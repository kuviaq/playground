...
# Put these in your bash profile to make this work
# export LUA_CPATH="/opt/local/var/luarocks/lib/lua/5.1//?.so;"
# export LUA_PATH="/opt/local/share/lua/5.1//?.lua;/opt/local/lib/luarocks/?.lua;/opt/local/var/luarocks/share/lua/5.1/?.lua;;"
